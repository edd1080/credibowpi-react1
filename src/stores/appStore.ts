...
export interface AppActions {
  ...
  updateApplicationSyncStatus: (applicationId: string, syncStatus: SyncStatus) => void;
...
export const useAppStore = create<AppState & AppActions>()(
  persist(
    (set, get) => ({
      ...
      updateApplication: (updatedApplication) => set((state) => ({
        applications: state.applications.map(app =>
          app.id === updatedApplication.id ? updatedApplication : app
        ),
        currentApplication: state.currentApplication?.id === updatedApplication.id
          ? updatedApplication
      ...
      updateApplicationStatus: (applicationId, status) => set((state) => ({
        applications: state.applications.map(app =>
          app.id === applicationId ? { ...app, status, updatedAt: new Date() } : app
        ),
      })),
      updateApplicationSyncStatus: (applicationId, syncStatus) => set((state) => ({
        applications: state.applications.map(app =>
...
export const useCurrentApplication = () => useAppStore((state) => state.currentApplication);
